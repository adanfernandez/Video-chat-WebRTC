    ...
    switch (data.type) {
      case "login":
        ...
        if (users[data.source]) {
          //username already exixsts, login not possible
          //sendTo connection with type and success
          //TODO
      ...
      case "offer":
        ...
        if (conn != null) {
          ...
          //send offer to conn
          //sendTo conn with type, offer and source
          //TODO
        }
      ...
      case "answer":
        ...
        if (conn != null) {
          connection.target = data.target;
          //send answer to conn
          //sendTo conn with type and answer
          //TODO
        }
